...
class jmz(op_codes.Op_code):
    ...
    def execute_ab(core, ins_reg, src_reg, dst_reg):
        jmz.execute_b(core, ins_reg, src_reg, dst_reg)

    @staticmethod
    def execute_ba(core, ins_reg, src_reg, dst_reg):
        jmz.execute_a(core, ins_reg, src_reg, dst_reg)
    ...
    def execute_x(core, ins_reg, src_reg, dst_reg):
        jmz.execute_f(core, ins_reg, src_reg, dst_reg)
